...
#
# project_DesignIat2ch.tcl: Tcl script for re-creating project 'project_3'
#
# Generated by Vivado on Thu Apr 04 06:40:18 -0500 2024
...
#
# 1. This project restoration tcl script (project_DesignIat2ch.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/fpga/vivado/project_3/project_3.srcs/constrs_1/new/constr1.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project_3.srcs/constrs_1/new/constr1.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../Users/melny/AppData/Roaming/Xilinx/Vivado/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "project_DesignIat2ch.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../Users/melny/AppData/Roaming/Xilinx/Vivado/2020.2.2/xhub/board_store/xilinx_board_store"]" -objects $obj
...
set_property -name "top" -value "design_iat2ch_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/project_3.srcs/constrs_1/new/constr1.xdc"]"
...
# Proc to create BD design_iat2ch
proc cr_bd_design_iat2ch { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name design_iat2ch
  ...
  xilinx.com:user:cascade3:1.0\
  xilinx.com:user:eventSimSmart:1.0\
  xilinx.com:user:iatcollector2chSmart_axis:1.0\
  ...
  # Create ports
  set channel1_0 [ create_bd_port -dir I channel1_0 ]
  set channel2_0 [ create_bd_port -dir I channel2_0 ]
  ...
  # Create instance: cascade3_0, and set properties
  set cascade3_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cascade3:1.0 cascade3_0 ]

  # Create instance: cascade3_1, and set properties
  set cascade3_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:cascade3:1.0 cascade3_1 ]

  # Create instance: eventSimSmart_0, and set properties
  set eventSimSmart_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:eventSimSmart:1.0 eventSimSmart_0 ]

  # Create instance: iatcollector2chSmart_0, and set properties
  set iatcollector2chSmart_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:iatcollector2chSmart_axis:1.0 iatcollector2chSmart_0 ]
  set_property CONFIG.C_M_AXIS_TDATA_WIDTH {16} $iatcollector2chSmart_0
...
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned} \
    CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#cd#wp#tx#rx#unassigned#unassigned#unassigned#unassigned}\
\
  ...
  connect_bd_intf_net -intf_net iatcollector2chSmart_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins iatcollector2chSmart_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins eventSimSmart_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins iatcollector2chSmart_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net cascade3_0_output_casc [get_bd_pins cascade3_0/output_casc] [get_bd_pins iatcollector2chSmart_0/channel1]
  connect_bd_net -net cascade3_1_output_casc [get_bd_pins cascade3_1/output_casc] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net eventSimSmart_0_eventOut [get_bd_pins eventSimSmart_0/eventOut] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net iatcollector2chSmart_0_fifo_overflow [get_bd_pins iatcollector2chSmart_0/fifo_overflow] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net input_casc_0_1 [get_bd_ports channel1_0] [get_bd_pins cascade3_0/input_casc]
  connect_bd_net -net input_casc_0_2 [get_bd_ports channel2_0] [get_bd_pins cascade3_1/input_casc]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins cascade3_0/clk] [get_bd_pins cascade3_1/clk] [get_bd_pins eventSimSmart_0/S_AXI_ACLK] [get_bd_pins iatcollector2chSmart_0/M_AXIS_ACLK] [get_bd_pins iatcollector2chSmart_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn1 [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins eventSimSmart_0/S_AXI_ARESETN] [get_bd_pins iatcollector2chSmart_0/M_AXIS_ARESETN] [get_bd_pins iatcollector2chSmart_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins iatcollector2chSmart_0/channel2] [get_bd_pins util_vector_logic_0/Res]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs eventSimSmart_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs iatcollector2chSmart_0/S_AXI/reg0] -force
...
# End of cr_bd_design_iat2ch()
cr_bd_design_iat2ch ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_iat2ch.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_iat2ch.bd ] 
set_property IS_ENABLED "1" [get_files design_iat2ch.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_iat2ch.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design_iat2ch.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_iat2ch.bd ] 
set_property PFM_NAME "" [get_files design_iat2ch.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_iat2ch.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_iat2ch.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_iat2ch.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_iat2ch.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_iat2ch.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_iat2ch.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse design_iat2ch.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project_3.gen/sources_1/bd/design_iat2ch/hdl/design_iat2ch_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse design_iat2ch.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/project_3.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/project_3.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/project_3.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
